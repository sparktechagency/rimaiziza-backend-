...
const handleCheckoutSessionCompleted = (session) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const booking = yield booking_model_1.Booking.findOneAndUpdate({ _id: transaction.bookingId, bookingStatus: booking_interface_1.BOOKING_STATUS.PENDING }, {
...
const handleExtendBookingSuccess = (session) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const extensionPlatformFee = ((_b = transaction.charges) === null || _b === void 0 ? void 0 : _b.platformFee) || 0;
    const extensionHostCommission = ((_c = transaction.charges) === null || _c === void 0 ? void 0 : _c.hostCommission) || 0;
    const extensionAdminCommission = ((_d = transaction.charges) === null || _d === void 0 ? void 0 : _d.adminCommission) || 0;
    const extensionRentalPrice = transaction.amount - extensionPlatformFee;
    booking.rentalPrice =
        (booking.rentalPrice || 0) + extensionRentalPrice;
    booking.platformFee =
...
const handleAccountUpdated = (account) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (account.charges_enabled &&
        ((_b = (_a = account.requirements) === null || _a === void 0 ? void 0 : _a.currently_due) === null || _b === void 0 ? void 0 : _b.length) === 0) {
        console.log("Account ready for onboarding:", account.id, "update start");
        const host = yield user_model_1.User.findOneAndUpdate({ stripeConnectedAccountId: account.id }, { isStripeOnboarded: true }, { new: true });
...
const markBookingOngoing = (bookingId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!booking)
        return;
    const now = new Date();
    if ((booking.bookingStatus === booking_interface_1.BOOKING_STATUS.CONFIRMED ||
...
const markBookingCompleted = (bookingId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!booking)
        return;
    const now = new Date();
    if (booking.bookingStatus === booking_interface_1.BOOKING_STATUS.ONGOING &&
        booking.toDate <= now) {
        ...
        const totalHostCommission = booking.hostCommission || 0;
        console.log(`ℹ Host commission for booking ${booking._id}: ${totalHostCommission} (To be paid manually)`);
    }
});
...
const bookingStatusCronJob = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const expiredBookings = yield booking_model_1.Booking.find({
        bookingStatus: { $in: [booking_interface_1.BOOKING_STATUS.REQUESTED, booking_interface_1.BOOKING_STATUS.PENDING] },
        fromDate: { $lte: now },
    });
    ...
    for (const booking of expiredBookings) {
        try {
            booking.bookingStatus = booking_interface_1.BOOKING_STATUS.EXPIRED;
            yield booking.save();
            ...
            console.warn(`Failed to mark booking ${booking._id} as EXPIRED:`, err.message);
        }
    }
});
