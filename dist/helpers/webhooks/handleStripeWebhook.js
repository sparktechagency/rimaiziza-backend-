...
exports.bookingStatusCronJob =
  exports.refundDepositIfEligible =
  exports.markBookingCompleted =
  exports.markBookingOngoing =
  exports.handleStripeWebhook =
  exports.handleExtendBookingSuccess =
  exports.handleCheckoutSessionCompleted =
    void 0;
...
const handleCheckoutSessionCompleted = (session) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const transaction = yield transaction_model_1.Transaction.findById(
    ...
    const booking = yield booking_model_1.Booking.findOneAndUpdate(
      {
...
const handleExtendBookingSuccess = (session) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    const transactionId =
      (_a = session.metadata) === null || _a === void 0
        ? void 0
        : _a.transactionId;
    if (!transactionId) return;
    const transaction =
      yield transaction_model_1.Transaction.findById(transactionId);
    if (!transaction) return;
    ...
    const extensionPlatformFee =
      ((_b = transaction.charges) === null || _b === void 0
        ? void 0
        : _b.platformFee) || 0;
    const extensionHostCommission =
      ((_c = transaction.charges) === null || _c === void 0
        ? void 0
        : _c.hostCommission) || 0;
    const extensionAdminCommission =
      ((_d = transaction.charges) === null || _d === void 0
        ? void 0
        : _d.adminCommission) || 0;
    const extensionRentalPrice = transaction.amount - extensionPlatformFee;
    booking.rentalPrice = (booking.rentalPrice || 0) + extensionRentalPrice;
...
const handleAccountUpdated = (account) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ...
      ((_b =
        (_a = account.requirements) === null || _a === void 0
          ? void 0
          : _a.currently_due) === null || _b === void 0
        ? void 0
        : _b.length) === 0
    ) {
      const host = yield user_model_1.User.findOneAndUpdate(
      ...
      console.log("Account not ready for onboarding:", {
        ...
        currently_due:
          (_c = account.requirements) === null || _c === void 0
            ? void 0
            : _c.currently_due,
      });
    }
    ...
    try {
      switch (event.type) {
        case "checkout.session.completed":
          ...
          if (
            transaction.type === transaction_interface_1.TRANSACTION_TYPE.EXTEND
          ) {
...
const markBookingOngoing = (bookingId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const booking = yield booking_model_1.Booking.findById(bookingId);
    if (!booking) return;
    const now = new Date();
    if (
      (booking.bookingStatus === booking_interface_1.BOOKING_STATUS.CONFIRMED ||
...
const refundDepositIfEligible = (bookingId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const booking = yield booking_model_1.Booking.findById(bookingId)
      .populate("carId")
      .populate("transactionId");
