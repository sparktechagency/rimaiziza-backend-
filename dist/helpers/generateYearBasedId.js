...
exports.generateBookingId =
  exports.generateVehicleId =
  exports.generateMembershipId =
    void 0;
...
const findLastMembershipId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastHost = yield user_model_1.User.findOne(
      { role: user_1.USER_ROLES.HOST }, // host role
      { membershipId: 1, _id: 0 },
    )
      .sort({ createdAt: -1 })
      .lean();
    return (
      (lastHost === null || lastHost === void 0
        ? void 0
        : lastHost.membershipId) || null
    );
  });
...
const findLastVehicleId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastCar = yield car_model_1.Car.findOne(
      {}, // all cars
      { vehicleId: 1, _id: 0 },
    )
      .sort({ createdAt: -1 })
      .lean();
    return (
      (lastCar === null || lastCar === void 0 ? void 0 : lastCar.vehicleId) ||
      null
    );
  });
