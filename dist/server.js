...
require("./app/modules/booking/booking.cron");
//uncaught exception
  ...
  return __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      logger_1.logger.info(
        colors_1.default.green("🚀 Database connected successfully"),
      );
      const port =
      ...
      server = app_1.default.listen(port, config_1.default.ip_address, () => {
        logger_1.logger.info(
          colors_1.default.yellow(
            `♻️  Application listening on port:${config_1.default.port}`,
          ),
        );
      });
      //socket
      ...
      logger_1.errorLogger.error(
        colors_1.default.red("🤢 Failed to connect Database"),
      );
    }
