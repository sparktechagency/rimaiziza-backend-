...
const createChatIntoDB = (participants) =>
...
const markChatAsRead = (userId, chatId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return chat_model_1.Chat.findByIdAndUpdate(
      chatId,
...
const getAllChatsFromDB = (userId, query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const searchTerm =
      (_a = query.searchTerm) === null || _a === void 0
        ? void 0
        : _a.toLowerCase();
    ...
    if (searchTerm) {
      const allChats = yield chat_model_1.Chat.find(chatQuery)
        ...
        .lean()
        .sort({ updatedAt: -1 });
      const allChatLists = yield Promise.all(
        allChats.map((chat) =>
          __awaiter(void 0, void 0, void 0, function* () {
...
const getChatImagesFromDB = (chatId, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const softDeleteChatForUser = (chatId, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
