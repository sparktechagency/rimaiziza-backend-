...
const createChargesToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield charges_model_1.Charges.findOneAndUpdate(
      {},
...
const getAllChargesFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield charges_model_1.Charges.findOne();
    if (!result) {
      throw new ApiErrors_1.default(
        404,
        "There are no charges is available in database",
      );
    }
    return result;
  });
const deleteChargesFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getDynamicCharges = (_a) =>
  __awaiter(void 0, [_a], void 0, function* ({ totalAmount }) {
