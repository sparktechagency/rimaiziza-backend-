...
// get notifications
const getNotificationFromDB = (user) =>
...
const readNotificationToDB = (user) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const adminNotificationFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const queryBuilder = new queryBuilder_1.default(
      baseQuery,
      query,
    ).paginate();
...
const adminReadNotificationToDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notification_model_1.Notification.updateMany(
      { type: notification_constant_1.NOTIFICATION_TYPE.ADMIN, read: false },
      { $set: { read: true } },
      { new: true },
    );
    return result;
