...
const createAdminToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const adminPayload = Object.assign(Object.assign({}, payload), {
      verified: true,
...
// --- HOST SERVICES ---
const createHostToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isExistHost = yield user_model_1.User.findOne({
      email: payload.email,
    });
    if (isExistHost) {
      throw new ApiErrors_1.default(
    ...
    const membershipId = yield (0,
    generateYearBasedId_1.generateMembershipId)();
    const hostPayload = Object.assign(Object.assign({}, payload), {
      verified: true,
      status: user_1.STATUS.ACTIVE,
...
const ghostLoginAsHost = (superAdmin, hostId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (superAdmin.role !== user_1.USER_ROLES.SUPER_ADMIN) {
      throw new ApiErrors_1.default(
        403,
        "Unauthorized: Only SuperAdmin can use ghost mode",
      );
    }
      ...
      hostsWithVehicles.map((host) =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          if (vehicleIds.length) {
            const revenueBookings = yield booking_model_1.Booking.aggregate([
              {
                $match: {
                  carId: { $in: vehicleIds },
                  bookingStatus: {
                    $ne: booking_interface_1.BOOKING_STATUS.CANCELLED,
                  },
            ...
            totalRevenue =
              (_b =
                (_a = revenueBookings[0]) === null || _a === void 0
                  ? void 0
                  : _a.revenue) !== null && _b !== void 0
                ? _b
                : 0;
          }
...
const deleteHostByIdFromD = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
      throw new ApiErrors_1.default(
        404,
        "Host doest not exist in the database",
      );
    }
...
const getTotalUsersAndHostsFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const createUserToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createAccountTemplate =
      emailTemplate_1.emailTemplate.createAccount(values);
    ...
    if (profile.role === user_1.USER_ROLES.HOST) {
      ...
      const successRate =
        totalBookings > 0
          ...
          : 0;
      const hostCar = yield car_model_1.Car.findOne(
        { assignedHosts: id },
        { _id: 1 },
      );
      if (!hostCar)
        throw new ApiErrors_1.default(404, "Host does not have any car");
      const trips = yield (0, car_utils_1.getCarTripCount)(
        hostCar === null || hostCar === void 0 ? void 0 : hostCar._id,
      );
      // Review summary
      const reviewSummary =
...
const updateProfileToDB = (user, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.coverImage && isExistUser.coverImage) {
      (0, unlinkFile_1.default)(isExistUser.coverImage);
    }
...
const getAllUsersFromDB = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const usersWithStats = users.map((user) => {
      ...
      return Object.assign(Object.assign({}, user.toObject()), {
        bookingCount:
          (stats === null || stats === void 0 ? void 0 : stats.totalBookings) ||
          0,
        totalSpent:
          (stats === null || stats === void 0 ? void 0 : stats.totalSpent) || 0,
      });
    });
    return {
      data: usersWithStats,
...
const deleteProfileFromDB = (id, password) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // user exists?
