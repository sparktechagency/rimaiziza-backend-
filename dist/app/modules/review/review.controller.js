...
const createReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield review_service_1.ReviewServices.createReview(payload, reviewById);
...
const getReviewSummary = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield review_service_1.ReviewServices.getReviewSummary(reviewForId, reviewType);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
