...
const createReview = (payload, reviewerId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (![review_interface_1.REVIEW_TARGET_TYPE.HOST, review_interface_1.REVIEW_TARGET_TYPE.USER].includes(reviewType))
    ...
    if (already)
        throw new ApiErrors_1.default(400, "You have already reviewed this user/host");
    ...
    const type = reviewType === review_interface_1.REVIEW_TARGET_TYPE.HOST
...
const getReviewSummary = (reviewForId, reviewType) => __awaiter(void 0, void 0, void 0, function* () {
...
const getBulkReviewSummary = (targetIds, reviewType) => __awaiter(void 0, void 0, void 0, function* () {
...
const checkIfAlreadyReviewed = (reviewById, reviewForId) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield review_model_1.Review.exists({
        reviewById: new mongoose_1.Types.ObjectId(reviewById),
        reviewForId: new mongoose_1.Types.ObjectId(reviewForId),
    });
    return !!isExist;
});
const getBulkReviewStatus = (reviewById, targetIds) => __awaiter(void 0, void 0, void 0, function* () {
    const reviews = yield review_model_1.Review.find({
        reviewById: new mongoose_1.Types.ObjectId(reviewById),
        reviewForId: { $in: targetIds.map((id) => new mongoose_1.Types.ObjectId(id)) },
    }).select("reviewForId");
