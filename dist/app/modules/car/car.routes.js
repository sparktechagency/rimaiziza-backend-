...
router.route("/host").get((0, auth_1.default)(user_1.USER_ROLES.HOST), car_controller_1.CarControllers.getCarsByHost);
router
    .route("/user/:id")
    .get((0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.HOST), car_controller_1.CarControllers.getCarByIdForUser);
router
    .route("/availability/:carId")
    .get((0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.HOST), car_controller_1.CarControllers.getAvailability);
router
    .route("/")
