...
router
  .route("/nearby")
  .get(
    (0, auth_1.default)(user_1.USER_ROLES.USER),
    car_controller_1.CarControllers.getNearbyCars,
  );
router
  .route("/host")
  .get(
    (0, auth_1.default)(user_1.USER_ROLES.HOST),
    car_controller_1.CarControllers.getCarsByHost,
  );
router
  .route("/user/:id")
  .get(
    (0, auth_1.default)(user_1.USER_ROLES.USER),
    car_controller_1.CarControllers.getCarByIdForUser,
  );
router
  .route("/availability/:carId")
  .get(
    (0, auth_1.default)(user_1.USER_ROLES.USER),
    car_controller_1.CarControllers.getAvailability,
  );
router
  .route("/")
  .post(
    (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN),
  ...
  .get(
    (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN),
    car_controller_1.CarControllers.getAllCars,
  );
router
  .route("/:id")
  ...
  .patch(
    ...
    car_controller_1.CarControllers.updateCarById,
  )
  .delete(
    (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN),
    car_controller_1.CarControllers.deleteCarById,
  );
