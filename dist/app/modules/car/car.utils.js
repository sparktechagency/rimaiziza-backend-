...
exports.checkIfUserHasPaid = exports.notifyAdminCarAction = exports.validateAvailabilityStrict = exports.generateRequestedHours = exports.getLocalDetails = exports.getCarTripCountMap = exports.getCarTripCount = exports.getCarCalendar = exports.checkCarAvailabilityByDate = exports.attachFavoriteToCar = exports.getTargetLocation = void 0;
...
const getTargetLocation = (queryLat, queryLng, userId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if ((!lat || !lng) && userId) {
        ...
        if ((_a = user === null || user === void 0 ? void 0 : user.location) === null || _a === void 0 ? void 0 : _a.coordinates) {
...
const attachFavoriteToCar = (car, userId) => __awaiter(void 0, void 0, void 0, function* () {
...
const checkCarAvailabilityByDate = (car, targetDate) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    // Car inactive
    if (!car.isActive)
        return false;
    ...
    const dayName = targetDate
        ...
        .toUpperCase();
    if (((_a = car.availableDays) === null || _a === void 0 ? void 0 : _a.length) && !car.availableDays.includes(dayName)) {
        return false;
    }
    // Check blockedDates
    const dateString = targetDate.toISOString().split("T")[0];
    const isBlocked = (_b = car.blockedDates) === null || _b === void 0 ? void 0 : _b.some((b) => new Date(b.date).toISOString().split("T")[0] === dateString);
    if (isBlocked)
        return false;
...
const getCarCalendar = (carId) => __awaiter(void 0, void 0, void 0, function* () {
    const calendar = [];
    ...
    for (let i = 0; i < 30; i++) {
        ...
        const availability = yield car_service_1.CarServices.getAvailability(carId, dateString);
...
const getCarTripCount = (carId) => __awaiter(void 0, void 0, void 0, function* () {
...
// bulk car trip
const getCarTripCountMap = (carIds) => __awaiter(void 0, void 0, void 0, function* () {
...
const validateAvailabilityStrict = (carId, from, to) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    if (from >= to)
    ...
    const requestedSlots = (0, exports.generateRequestedHours)(fromDate, toDate);
    ...
    for (const [date, hours] of Object.entries(dateMap)) {
        ...
        const blockedEntry = (_a = car.blockedDates) === null || _a === void 0 ? void 0 : _a.find((b) => new Date(b.date).toISOString().split("T")[0] === date);
        if (blockedEntry) {
            throw new ApiErrors_1.default(400, `Car blocked on ${date}: ${blockedEntry.reason || "Blocked by host"}`);
        }
        ...
        if (((_b = car.availableDays) === null || _b === void 0 ? void 0 : _b.length) && !car.availableDays.includes(dayName)) {
            throw new ApiErrors_1.default(400, `Car not available on ${date} (${dayName})`);
        }
        ...
        for (const hour of hours) {
            if (!openHoursSet.has(hour)) {
                throw new ApiErrors_1.default(400, `Car not available on ${date} at ${String(hour).padStart(2, "0")}:00 (outside operating hours)`);
            }
            if (bookedHours.has(hour)) {
                throw new ApiErrors_1.default(400, `Car already booked on ${date} at ${String(hour).padStart(2, "0")}:00`);
            }
        }
    }
...
const notifyAdminCarAction = (action, carId) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.notifyAdminCarAction = notifyAdminCarAction;
const checkIfUserHasPaid = (carId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    if (!userId || !mongoose_1.Types.ObjectId.isValid(userId))
        return false;
    if (!carId || !mongoose_1.Types.ObjectId.isValid(carId))
        return false;
    // Find any booking by this user for this car that has a successful payment
    const paidBooking = yield booking_model_1.Booking.findOne({
        carId: new mongoose_1.Types.ObjectId(carId),
        ...
        bookingStatus: {
            $in: [
                ...
                booking_interface_1.BOOKING_STATUS.COMPLETED,
            ],
        },
    })
    ...
    const transaction = paidBooking.transactionId;
    if (!transaction)
        return false;
    return transaction.status === transaction_interface_1.TRANSACTION_STATUS.SUCCESS;
});
exports.checkIfUserHasPaid = checkIfUserHasPaid;
