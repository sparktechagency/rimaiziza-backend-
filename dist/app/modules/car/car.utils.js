...
exports.checkIfUserHasPaid =
  exports.notifyAdminCarAction =
...
const notifyAdminCarAction = (action, carId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const checkIfUserHasPaid = (carId, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!userId || !mongoose_1.Types.ObjectId.isValid(userId)) return false;
    if (!carId || !mongoose_1.Types.ObjectId.isValid(carId)) return false;
