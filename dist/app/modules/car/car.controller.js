...
const getAllCars = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getCarById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateCarById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const carData = req.body;
    console.log(carData);
    const result = yield car_service_1.CarServices.updateCarByIdToDB(
      id,
      carData,
    );
    (0, sendResponse_1.default)(res, {
...
const deleteCarById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
...
const getNearbyCars = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const userId =
      ...
      null;
    const result = yield car_service_1.CarServices.getNearbyCarsFromDB(
      Object.assign(Object.assign({}, req.query), { userId }),
    );
    (0, sendResponse_1.default)(res, {
      statusCode: 200,
      success: true,
...
const getCarByIdForUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id: userId } = req.user;
    const { id } = req.params;
    const result = yield car_service_1.CarServices.getCarByIdForUserFromDB(
      id,
      userId,
    );
    (0, sendResponse_1.default)(res, {
...
const getCarsByHost = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
