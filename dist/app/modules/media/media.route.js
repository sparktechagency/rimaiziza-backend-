...
router
  ...
  .post(
    ...
    media_controller_1.MediaControllers.createMedia,
  )
  .get(media_controller_1.MediaControllers.getMediaByType);
router.patch(
  "/status/:mediaId",
  (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN),
  media_controller_1.MediaControllers.updateMediaStatus,
);
router
  .route("/:mediaId")
  .patch(
    ...
    media_controller_1.MediaControllers.updateMediaById,
  )
  .delete(
    (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN),
    media_controller_1.MediaControllers.deleteMedia,
  );
