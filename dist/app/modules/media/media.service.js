...
const createMediaToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { type, description } = payload;
    if (
      ![
        media_interface_1.MEDIA_TYPE.BANNER,
        media_interface_1.MEDIA_TYPE.FEED,
      ].includes(payload.type)
    ) {
      throw new ApiErrors_1.default(
        400,
        "Media type must be 'BANNER' or 'FEED'",
      );
    }
...
const getMediaByTypeFromDB = (type_1, ...args_1) =>
  __awaiter(
    void 0,
    [type_1, ...args_1],
    void 0,
    function* (type, includeInactive = false) {
      if (
        ![
          media_interface_1.MEDIA_TYPE.BANNER,
          media_interface_1.MEDIA_TYPE.FEED,
...
const updateMediaByIdToDB = (mediaId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (
      payload.type &&
      ![
    ...
    const updatedMedia = yield media_model_1.Media.findByIdAndUpdate(
      mediaId,
      { $set: payload },
      { new: true },
    );
