...
const getDashboardStats = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const activeVehicles = yield car_model_1.Car.countDocuments({
        isActive: true,
      });
      ...
      return {
        ...
        activeVehicles,
        totalCustomers:
          ((_a = totalCustomers[0]) === null || _a === void 0
            ? void 0
            : _a.totalCustomers) || 0,
      };
    } catch (error) {
...
const getYearlyRevenueChart = (year) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = Array.from({ length: 12 }, (_, i) => {
      ...
      return {
        month: i + 1,
        totalRevenue:
          (monthData === null || monthData === void 0
            ? void 0
            : monthData.totalRevenue) || 0,
        platformFee:
          (monthData === null || monthData === void 0
            ? void 0
            : monthData.platformFee) || 0,
        hostEarnings:
          (monthData === null || monthData === void 0
            ? void 0
            : monthData.hostEarnings) || 0,
      };
    });
    return {
      year: currentYear,
...
const getYearlyBookingAndUserChart = (year) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getUserStats = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalCustomers =
      ((_a = customersAgg[0]) === null || _a === void 0
        ? void 0
        : _a.totalCustomers) || 0;
    return {
      totalUsers,
                  ...
                  $and: [
                    {
                      $ne: [
                        "$bookingStatus",
                        booking_interface_1.BOOKING_STATUS.CANCELLED,
                      ],
                    },
                    {
                      $eq: [
...
const getHostDashboardStats = (hostId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    const totalEarning =
      (_b =
        (_a = earningResult[0]) === null || _a === void 0
          ? void 0
          : _a.totalEarning) !== null && _b !== void 0
        ? _b
        : 0;
    // ------------------ TOTAL TRIPS ------------------
...
const getHostMonthlyEarnings = (hostId, year) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!hostId || !mongoose_1.Types.ObjectId.isValid(hostId)) {
      throw new ApiErrors_1.default(400, "Invalid hostId");
    }
