...
const checkFavoriteCarStatus = (userId, referenceId) =>
...
const toggleFavorite = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existing = yield favoriteCar_model_1.FavoriteCar.findOne({
      userId,
      referenceId,
    });
    if (existing) {
...
const getFavorite = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const carIds = favorites
      .map((fav) => {
        var _a;
        return (_a = fav.referenceId) === null || _a === void 0
          ? void 0
          : _a._id;
      })
      .filter(Boolean)
    ...
    const finalFavorites = yield Promise.all(
      favorites.map((fav) =>
        __awaiter(void 0, void 0, void 0, function* () {
          var _a, _b, _c;
          console.log(fav, "fav");
          const carId =
            (_b =
              (_a = fav.referenceId) === null || _a === void 0
                ? void 0
          ...
          if (!carId) return fav;
          const hostId = (
            (_c = fav.referenceId) === null || _c === void 0
              ? void 0
              : _c.userId
          )
          ...
          return Object.assign(Object.assign({}, fav), {
            referenceId: Object.assign(Object.assign({}, fav.referenceId), {
...
const getSingleFavorite = (userId, favoriteId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const favorite = yield favoriteCar_model_1.FavoriteCar.findOne({
      _id: favoriteId,
      userId,
...
const deleteFavorite = (userId, referenceId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield favoriteCar_model_1.FavoriteCar.deleteOne({
      userId,
      referenceId,
    });
