...
const getFavorite = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const finalFavorites = yield Promise.all(favorites.map((fav) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return Object.assign(Object.assign({}, fav), { referenceId: Object.assign(Object.assign({}, fav.referenceId), { trips: tripCountMap[carId] || 0, averageRating: reviewSummary ? reviewSummary.averageRating : undefined, totalReviews: reviewSummary ? reviewSummary.totalReviews : undefined, starCounts: reviewSummary ? reviewSummary.starCounts : undefined, reviews: reviewSummary ? reviewSummary.reviews : undefined }) });
    })));
