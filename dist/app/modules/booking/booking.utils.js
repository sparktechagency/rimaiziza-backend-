...
const calculateFirstTimeBookingAmount = (from, to, car) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const adminCommission = +(baseRentalPrice -
        platformFee -
        hostCommission).toFixed(2);
...
const calculateExtendBookingAmount = (from, to, car) => __awaiter(void 0, void 0, void 0, function* () {
    if (!from || !to) {
    ...
    const adminCommission = +(baseExtendPrice -
        platformFee -
        hostCommission).toFixed(2);
