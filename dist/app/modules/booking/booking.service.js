...
const createBookingToDB = (payload, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const calculation = yield (0,
    booking_utils_1.calculateFirstTimeBookingAmount)(
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const targetIds = data
      .map((b) => {
        var _a, _b;
        return (_b =
          (_a = b.userId) === null || _a === void 0 ? void 0 : _a._id) ===
          null || _b === void 0
          ? void 0
          : _b.toString();
      })
      .filter(Boolean);
    const reviewedSet =
      yield review_service_1.ReviewServices.getBulkReviewStatus(
        hostId,
        targetIds,
      );
    const dataWithReviewStatus = data.map((b) => {
      ...
      return Object.assign(Object.assign({}, b), {
        isReviewed: reviewedSet.has(
          (_b = (_a = b.userId) === null || _a === void 0 ? void 0 : _a._id) ===
            null || _b === void 0
            ? void 0
            : _b.toString(),
        ),
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const targetIds = data
      .map((b) => {
        var _a, _b;
        return (_b =
          (_a = b.hostId) === null || _a === void 0 ? void 0 : _a._id) ===
          null || _b === void 0
          ? void 0
          : _b.toString();
      })
    ...
    const dataWithReviewStatus = data.map((b) => {
      ...
      return Object.assign(Object.assign({}, b), {
        isReviewed: reviewedSet.has(
          (_b = (_a = b.hostId) === null || _a === void 0 ? void 0 : _a._id) ===
            null || _b === void 0
            ? void 0
            : _b.toString(),
        ),
...
const getHostBookingByIdFromDB = (bookingId, hostId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isReviewed =
      yield review_service_1.ReviewServices.checkIfAlreadyReviewed(
        hostId,
        booking.userId._id.toString(),
      );
    return Object.assign(Object.assign({}, booking), { isReviewed });
  });
const getUserBookingByIdFromDB = (bookingId, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.Types.ObjectId.isValid(bookingId)) {
      throw new ApiErrors_1.default(400, "Invalid booking id");
    }
