...
const getHostBookingsFromDB = (hostId, query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const targetIds = data.map((b) => { var _a, _b; return (_b = (_a = b.userId) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString(); }).filter(Boolean);
...
const getUserBookingsFromDB = (userId, query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const targetIds = data.map((b) => { var _a, _b; return (_b = (_a = b.hostId) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString(); }).filter(Boolean);
    const reviewedSet = yield review_service_1.ReviewServices.getBulkReviewStatus(userId, targetIds);
    const dataWithReviewStatus = data.map((b) => {
        var _a, _b;
        return (Object.assign(Object.assign({}, b), { isReviewed: reviewedSet.has((_b = (_a = b.hostId) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString()) }));
    });
    return {
        meta: {
            page: Number(page),
...
const cancelBookingFromDB = (bookingId, actorId, actorRole) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (transaction &&
        ...
        if (chargeAmount < 0)
            chargeAmount = 0;
        if (chargeAmount > totalRental)
            chargeAmount = totalRental; // Should not exceed total rental
