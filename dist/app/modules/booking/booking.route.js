...
router
    .route("/")
    .post((0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.HOST, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, fileUploaderHandler_1.default)(), (0, parseAllFileData_1.default)({ fieldName: "nidFrontPic", forceSingle: true }, { fieldName: "nidBackPic", forceSingle: true }, { fieldName: "drivingLicenseFrontPic", forceSingle: true }, { fieldName: "drivingLicenseBackPic", forceSingle: true }), booking_controller_1.BookingControllers.createBookingToDB);
router
    .route("/host")
...
router
    .route("/host/self")
    .get((0, auth_1.default)(user_1.USER_ROLES.HOST, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), booking_controller_1.BookingControllers.getSelfBookingsByHost);
router
    .route("/host/:bookingId")
    .get((0, auth_1.default)(user_1.USER_ROLES.HOST, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), booking_controller_1.BookingControllers.getHostBookingById)
...
router
    ...
    .get((0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), booking_controller_1.BookingControllers.getUserBookingById);
router.get("/success", booking_controller_1.BookingControllers.paymentSuccess);
router.get("/fail", booking_controller_1.BookingControllers.paymentFail);
