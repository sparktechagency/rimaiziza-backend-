...
const getHostBookingById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id: hostId } = req.user;
    const { bookingId } = req.params;
    const result = yield booking_service_1.BookingServices.getHostBookingByIdFromDB(bookingId, hostId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const getUserBookingById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id: userId } = req.user;
    const { bookingId } = req.params;
    const result = yield booking_service_1.BookingServices.getUserBookingByIdFromDB(bookingId, userId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
