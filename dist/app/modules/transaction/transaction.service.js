...
const createBookingPaymentSession = (bookingId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, car_utils_1.validateAvailabilityStrict)(booking.carId._id.toString(), booking.fromDate, booking.toDate);
    //  car + deposit
    ...
    */
    ...
    const charges = yield (0, charges_service_1.getDynamicCharges)({
        baseAmount: booking.rentalPrice,
    });
    //  create transaction
...
const createExtendBookingPaymentSession = (bookingId, userId, newToDate) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (![booking_interface_1.BOOKING_STATUS.CONFIRMED, booking_interface_1.BOOKING_STATUS.ONGOING].includes(booking.bookingStatus)) {
        throw new ApiErrors_1.default(400, "Only active bookings can be extended");
    }
    if (newToDate <= booking.toDate) {
        throw new ApiErrors_1.default(400, "New end date must be after current booking end date");
    }
    // availability check
    yield (0, car_utils_1.validateAvailabilityStrict)(booking.carId._id.toString(), booking.toDate, newToDate);
    // calculate extended amount
    const car = booking.carId;
    const extensionCalculation = yield (0, booking_utils_1.calculateExtendBookingAmount)(booking.toDate, newToDate, car);
...
const getTransactionsFromDB = (userId, status) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (status) {
        ...
        transactionFilter.status = {
            $in: [transaction_interface_1.TRANSACTION_STATUS.SUCCESS, transaction_interface_1.TRANSACTION_STATUS.REFUNDED],
        };
    }
