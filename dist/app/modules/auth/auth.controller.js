...
const verifyEmail = (0, catchAsync_1.default)((req, res) =>
...
const resetPassword = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.resetPasswordToDB(
      token,
      resetData,
    );
    (0, sendResponse_1.default)(res, {
...
const newAccessToken = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const resendVerificationEmail = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    const result =
      yield auth_service_1.AuthService.resendVerificationEmailToDB(email);
    (0, sendResponse_1.default)(res, {
      success: true,
      statusCode: http_status_codes_1.StatusCodes.OK,
...
const deleteUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield auth_service_1.AuthService.deleteUserFromDB(
      req.user,
      req.body.password,
    );
    (0, sendResponse_1.default)(res, {
