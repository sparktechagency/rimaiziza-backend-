...
router.post(
  ...
  (0, validateRequest_1.default)(
    auth_validation_1.AuthValidation.createLoginZodSchema,
  ),
...
router.post(
  "/forget-password",
  (0, validateRequest_1.default)(
    auth_validation_1.AuthValidation.createForgetPasswordZodSchema,
  ),
...
router.post(
  "/resend-otp",
  auth_controller_1.AuthController.resendVerificationEmail,
);
router.post(
  "/verify-email",
  (req, res, next) =>
  ...
  (0, validateRequest_1.default)(
    auth_validation_1.AuthValidation.createVerifyEmailZodSchema,
  ),
...
router.post(
  "/reset-password",
  (0, validateRequest_1.default)(
    auth_validation_1.AuthValidation.createResetPasswordZodSchema,
  ),
...
router.post(
  ...
  (0, validateRequest_1.default)(
    auth_validation_1.AuthValidation.createChangePasswordZodSchema,
  ),
