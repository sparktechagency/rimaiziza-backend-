...
router.get(
  ...
  message_controller_1.MessageController.getMessages,
);
router.delete(
  "/delete/:messageId",
  (0, auth_1.default)(
  ...
  message_controller_1.MessageController.deleteMessage,
);
...
router.patch(
  ...
  message_controller_1.MessageController.pinUnpinMessage,
);
