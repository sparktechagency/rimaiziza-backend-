...
const sendMessageToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const messagePayload = Object.assign(Object.assign({}, payload), {
    ...
    yield chat_model_1.Chat.findByIdAndUpdate(
      response === null || response === void 0 ? void 0 : response.chatId,
      {
...
const getMessagesFromDB = (
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const formattedMessages = response.map((message) =>
      Object.assign(Object.assign({}, message.toObject()), {
...
const deleteMessage = (userId, messageId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const updateMessage = yield message_model_1.Message.findByIdAndUpdate(
        message._id,
        {
          $set: {
            isDeleted: true,
...
const pinUnpinMessage = (userId, messageId, action) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const message = yield message_model_1.Message.findById(messageId);
      if (!message) {
      ...
      if (action === "pin") {
        ...
        // Pin the message
        const updatedMessage = yield message_model_1.Message.findByIdAndUpdate(
          messageId,
          {
            $set: {
              isPinned: true,
