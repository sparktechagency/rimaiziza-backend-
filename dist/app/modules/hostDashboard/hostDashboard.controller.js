...
const getHostDashboard = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const hostId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id; // auth middleware থেকে আসবে
    const year = req.query.year
        ? Number(req.query.year)
        : new Date().getFullYear();
    const result = yield hostDashboard_service_1.HostDashboardService.getHostDashboardData(hostId, year);
