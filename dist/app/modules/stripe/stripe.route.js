...
router.route('/connect-account').post((0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.HOST), stripe_controller_1.StripeControllers.createStripeAccount);
