...
class QueryBuilder {
  ...
  search(searchableFields) {
    ...
    if (mongoose_1.Types.ObjectId.isValid(searchTerm)) {
      orConditions.push({ _id: new mongoose_1.Types.ObjectId(searchTerm) });
      orConditions.push({
  ...
  sort() {
    var _a;
    const sort =
      ((_a = this.query.sort) === null || _a === void 0
        ? void 0
        : _a.split(",").join(" ")) || "-createdAt";
  ...
  fields() {
    var _a;
    const fields =
      ((_a = this.query.fields) === null || _a === void 0
        ? void 0
        : _a.split(",").join(" ")) || "-__v";
