...
const optionalAuth = (...roles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!tokenWithBearer.startsWith('Bearer ')) {
            throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.UNAUTHORIZED, 'Token format is not valid !!');
        }
        ...
        if (user === null || user === void 0 ? void 0 : user.isDeleted) {
            throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.FORBIDDEN, 'This user account is deleted !!');
        }
